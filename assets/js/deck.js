/* Asset Management Modular Deck Controller
   ------------------------------------------------------------
   Funktionen:
...
(function () {
    ...
    const TOPIC_MANIFEST = window.ASSET_MANAGEMENT_TOPICS || [];
    ...
    function appendTopicSections(source, topic) {
        ...
        sections.forEach((sourceSection, index) => {
            ...
            section.dataset.module = section.dataset.module || "asset-management";
    ...
    function appendLoadErrorSlide(topic, error) {
        ...
        section.dataset.module = "asset-management";
        ...
        section.innerHTML = `
            <div class="chrome-top"><span>Asset Management</span><span>Load Error</span></div>
